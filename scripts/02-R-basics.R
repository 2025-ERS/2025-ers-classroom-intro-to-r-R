...
class_size <- 28 # assign the value 30 to the variable class_size
class_size # print the value of the variable class_size
...
date_var <- as.Date("2023-01-12") # assign the value "2023-01-01" to the variable date_var
date_var # print the value of date_var
class(date_var) # print the class of date_var
# But it is generally better to use lubridate to work with dates to confuse days and months
date_var2 <- lubridate::ymd("2023-12-18") # assign the value "2023-01-01" to the variable date_var2 using lubridate
...
date_var3 <- lubridate::dmy("18-Dec-2023") # assign the value "01-01-2023" to the variable date_var3 using lubridate
date_var3 # print the value of date_var3
class(date_var3) # print the class of date_var3
# You can also use lubridate to work with dates in different formats
date_var4 <- lubridate::mdy("Dec 18, 2023") # assign the value "01-01-2023" to the variable date_var4 using lubridate
...
# Objects can have different methods, which are functions that are specific to a certain class of objects
...
# You can also see the methods for a specific class of objects using the getS3method() function
getS3method("summary", "lm") # print the summary method for lm objects
